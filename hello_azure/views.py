...
def ask_openai(request):
    ...
    if request.method=='POST':
                    ...
                    if chunk_message is not None:
                        ...
                        if chunk_message in tts_sentence_end: # sentence end found
                            ...
                            if text != '' and stop_speech_synthesis!=True: # if sentence only have \n or space, we could skip
                                ...
                                # print("dajshgj",result.audio_data)
                                audio_data_list.append(str(result.audio_data))
                                # print("result",result)
                                # audio_data = result.audio_data
                                # print("audio_data",audio_data)
                                # audio_data_list.append(audio_data)
                                
                                # print("audio_data_list",audio_data_list)
        ...
        return JsonResponse({'message':audio_data_list})
